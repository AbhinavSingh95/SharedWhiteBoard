...
public class EraserStroke extends JPanel implements MouseListener,ActionListener, ChangeListener 
{
	/**
	 *Class responsible for the eraser strokes on the whiteboard
	 */
    ...
    public EraserStroke(PaintCanvas area) {
        ...
        wholePanel.setBorder(new TitledBorder(null, "Eraser Stroke",TitledBorder.LEFT, TitledBorder.TOP));
